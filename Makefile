.PHONY: test vet lint migrate sqlc regtest regtestswap regtestdown integrationtest integrationtest-swap keyrotation keyrotationrestart keyrotationruntime smokehd bump-client-lib bump-ark-lib bump-api-spec
