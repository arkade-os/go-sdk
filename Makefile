...
integrationtest:
	@ARK_ELECTRUM_URL=$${ARK_ELECTRUM_URL:-tcp://127.0.0.1:50001} ARK_ESPLORA_URL=$${ARK_ESPLORA_URL:-http://localhost:3000} ARK_ELECTRUM_WS_URL=$${ARK_ELECTRUM_WS_URL:-ws://localhost:3000/v1/ws} go test -v -count=1 -race -timeout 40m ./test/e2e
