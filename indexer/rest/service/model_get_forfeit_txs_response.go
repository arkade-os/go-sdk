...
func (o *GetForfeitTxsResponse) GetPage() PageResponse {
...
func (o *GetForfeitTxsResponse) GetPageOk() (*PageResponse, bool) {
	if o == nil || IsNil(o.Page) {
		return nil, false
	}
	return o.Page, true
...
func (o *GetForfeitTxsResponse) SetPage(v PageResponse) {
	o.Page = &v
}
