...
func TestHDWalletRestoresMixedOnchainAndOffchainState(t *testing.T) {
	...
	aliceClientHD := setupClient(t, "", sdk.WithRenewalScheduleInterval(time.Hour))
	bobClientHD := setupClient(t, "", sdk.WithRenewalScheduleInterval(time.Hour))
	...
	aliceClientHD = setupClient(t, seed, sdk.WithRenewalScheduleInterval(time.Hour))
