...
type IndexerVtxo struct {
	...
	Extensions      []*IndexerExtension    `protobuf:"bytes,14,rep,name=extensions,proto3" json:"extensions,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *IndexerVtxo) GetExtensions() []*IndexerExtension {
	if x != nil {
		return x.Extensions
	}
	return nil
...
type IndexerExtension struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to Kind:
	//
	//	*IndexerExtension_Asset
	Kind          isIndexerExtension_Kind `protobuf_oneof:"kind"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *IndexerExtension) Reset() {
	*x = IndexerExtension{}
...
func (x *IndexerExtension) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IndexerExtension) ProtoMessage() {}

func (x *IndexerExtension) ProtoReflect() protoreflect.Message {
	mi := &file_ark_v1_indexer_proto_msgTypes[26]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IndexerExtension.ProtoReflect.Descriptor instead.
func (*IndexerExtension) Descriptor() ([]byte, []int) {
	return file_ark_v1_indexer_proto_rawDescGZIP(), []int{26}
}

func (x *IndexerExtension) GetKind() isIndexerExtension_Kind {
	if x != nil {
		return x.Kind
	}
	return nil
...
func (x *IndexerExtension) GetAsset() *IndexerAsset {
	if x != nil {
		if x, ok := x.Kind.(*IndexerExtension_Asset); ok {
			return x.Asset
		}
	}
	return nil
...
type isIndexerExtension_Kind interface {
	isIndexerExtension_Kind()
}

type IndexerExtension_Asset struct {
	Asset *IndexerAsset `protobuf:"bytes,1,opt,name=asset,proto3,oneof"`
}

func (*IndexerExtension_Asset) isIndexerExtension_Kind() {}
...
type SubscribeForTeleportHashRequest struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	TeleportHashes []string               `protobuf:"bytes,1,rep,name=teleport_hashes,json=teleportHashes,proto3" json:"teleport_hashes,omitempty"`
	// If set, update an existing subscription
	SubscriptionId string `protobuf:"bytes,2,opt,name=subscription_id,json=subscriptionId,proto3" json:"subscription_id,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
...
func (x *SubscribeForTeleportHashRequest) Reset() {
	*x = SubscribeForTeleportHashRequest{}
	mi := &file_ark_v1_indexer_proto_msgTypes[36]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SubscribeForTeleportHashRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SubscribeForTeleportHashRequest) ProtoMessage() {}

func (x *SubscribeForTeleportHashRequest) ProtoReflect() protoreflect.Message {
	mi := &file_ark_v1_indexer_proto_msgTypes[36]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SubscribeForTeleportHashRequest.ProtoReflect.Descriptor instead.
func (*SubscribeForTeleportHashRequest) Descriptor() ([]byte, []int) {
	return file_ark_v1_indexer_proto_rawDescGZIP(), []int{36}
}

func (x *SubscribeForTeleportHashRequest) GetTeleportHashes() []string {
	if x != nil {
		return x.TeleportHashes
	}
	return nil
}

func (x *SubscribeForTeleportHashRequest) GetSubscriptionId() string {
	if x != nil {
		return x.SubscriptionId
	}
	return ""
...
func (x *SubscribeForTeleportHashResponse) Reset() {
	*x = SubscribeForTeleportHashResponse{}
	mi := &file_ark_v1_indexer_proto_msgTypes[37]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SubscribeForTeleportHashResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SubscribeForTeleportHashResponse) ProtoMessage() {}

func (x *SubscribeForTeleportHashResponse) ProtoReflect() protoreflect.Message {
	mi := &file_ark_v1_indexer_proto_msgTypes[37]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SubscribeForTeleportHashResponse.ProtoReflect.Descriptor instead.
func (*SubscribeForTeleportHashResponse) Descriptor() ([]byte, []int) {
	return file_ark_v1_indexer_proto_rawDescGZIP(), []int{37}
}

func (x *SubscribeForTeleportHashResponse) GetSubscriptionId() string {
	if x != nil {
		return x.SubscriptionId
	}
	return ""
...
type UnsubscribeForTeleportHashRequest struct {
	...
	TeleportHashes []string `protobuf:"bytes,2,rep,name=teleport_hashes,json=teleportHashes,proto3" json:"teleport_hashes,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}

func (x *UnsubscribeForTeleportHashRequest) Reset() {
	*x = UnsubscribeForTeleportHashRequest{}
	mi := &file_ark_v1_indexer_proto_msgTypes[38]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UnsubscribeForTeleportHashRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UnsubscribeForTeleportHashRequest) ProtoMessage() {}

func (x *UnsubscribeForTeleportHashRequest) ProtoReflect() protoreflect.Message {
	mi := &file_ark_v1_indexer_proto_msgTypes[38]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UnsubscribeForTeleportHashRequest.ProtoReflect.Descriptor instead.
func (*UnsubscribeForTeleportHashRequest) Descriptor() ([]byte, []int) {
	return file_ark_v1_indexer_proto_rawDescGZIP(), []int{38}
}

func (x *UnsubscribeForTeleportHashRequest) GetSubscriptionId() string {
	if x != nil {
		return x.SubscriptionId
	}
	return ""
...
func (x *UnsubscribeForTeleportHashRequest) GetTeleportHashes() []string {
	if x != nil {
		return x.TeleportHashes
	}
	return nil
...
type UnsubscribeForTeleportHashResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *UnsubscribeForTeleportHashResponse) Reset() {
	*x = UnsubscribeForTeleportHashResponse{}
	mi := &file_ark_v1_indexer_proto_msgTypes[39]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UnsubscribeForTeleportHashResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UnsubscribeForTeleportHashResponse) ProtoMessage() {}

func (x *UnsubscribeForTeleportHashResponse) ProtoReflect() protoreflect.Message {
	mi := &file_ark_v1_indexer_proto_msgTypes[39]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UnsubscribeForTeleportHashResponse.ProtoReflect.Descriptor instead.
func (*UnsubscribeForTeleportHashResponse) Descriptor() ([]byte, []int) {
...
func (x *TeleportEvent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TeleportEvent) ProtoMessage() {}

func (x *TeleportEvent) ProtoReflect() protoreflect.Message {
	mi := &file_ark_v1_indexer_proto_msgTypes[40]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TeleportEvent.ProtoReflect.Descriptor instead.
func (*TeleportEvent) Descriptor() ([]byte, []int) {
	return file_ark_v1_indexer_proto_rawDescGZIP(), []int{40}
}

func (x *TeleportEvent) GetTeleportHash() string {
	if x != nil {
		return x.TeleportHash
	}
	return ""
}

func (x *TeleportEvent) GetAnchorOutpoint() string {
	if x != nil {
...
func (x *TeleportEvent) GetCreatedAt() int64 {
	if x != nil {
		return x.CreatedAt
	}
	return 0
...
func (x *TeleportEvent) GetExpiresAt() int64 {
	if x != nil {
		return x.ExpiresAt
	}
	return 0
...
type IndexerSubscriptionEvent struct {
	...
	TeleportEvents []*TeleportEvent `protobuf:"bytes,8,rep,name=teleport_events,json=teleportEvents,proto3" json:"teleport_events,omitempty"`
	TeleportHashes []string         `protobuf:"bytes,9,rep,name=teleport_hashes,json=teleportHashes,proto3" json:"teleport_hashes,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *IndexerSubscriptionEvent) GetTeleportEvents() []*TeleportEvent {
	if x != nil {
		return x.TeleportEvents
	}
	return nil
}

func (x *IndexerSubscriptionEvent) GetTeleportHashes() []string {
	if x != nil {
		return x.TeleportHashes
	}
	return nil
...
const file_ark_v1_indexer_proto_rawDesc = "" +
	...
	"\bark_txid\x18\r \x01(\tR\aarkTxid\x128\n" +
	"\n" +
	"extensions\x18\x0e \x03(\v2\x18.ark.v1.IndexerExtensionR\n" +
	"extensions\"H\n" +
	"\x10IndexerExtension\x12,\n" +
	"\x05asset\x18\x01 \x01(\v2\x14.ark.v1.IndexerAssetH\x00R\x05assetB\x06\n" +
	"\x04kind\"A\n" +
	...
	"\x1dUnsubscribeForScriptsResponse\"s\n" +
	"\x1fSubscribeForTeleportHashRequest\x12'\n" +
	"\x0fteleport_hashes\x18\x01 \x03(\tR\x0eteleportHashes\x12'\n" +
	"\x0fsubscription_id\x18\x02 \x01(\tR\x0esubscriptionId\"K\n" +
	" SubscribeForTeleportHashResponse\x12'\n" +
	...
	"\x1aUnsubscribeForTeleportHash\x12).ark.v1.UnsubscribeForTeleportHashRequest\x1a*.ark.v1.UnsubscribeForTeleportHashResponse\"(\xb2J%B\x01*\" /v1/indexer/teleport/unsubscribe\x12\x8c\x01\n" +
...
var file_ark_v1_indexer_proto_msgTypes = make([]protoimpl.MessageInfo, 49)
var file_ark_v1_indexer_proto_goTypes = []any{
	...
	(*IndexerExtension)(nil),                   // 28: ark.v1.IndexerExtension
	(*IndexerAsset)(nil),                       // 29: ark.v1.IndexerAsset
	(*IndexerChain)(nil),                       // 30: ark.v1.IndexerChain
	(*IndexerTxHistoryRecord)(nil),             // 31: ark.v1.IndexerTxHistoryRecord
	(*IndexerPageRequest)(nil),                 // 32: ark.v1.IndexerPageRequest
	(*IndexerPageResponse)(nil),                // 33: ark.v1.IndexerPageResponse
	(*SubscribeForScriptsRequest)(nil),         // 34: ark.v1.SubscribeForScriptsRequest
	(*SubscribeForScriptsResponse)(nil),        // 35: ark.v1.SubscribeForScriptsResponse
	(*UnsubscribeForScriptsRequest)(nil),       // 36: ark.v1.UnsubscribeForScriptsRequest
	(*UnsubscribeForScriptsResponse)(nil),      // 37: ark.v1.UnsubscribeForScriptsResponse
	(*SubscribeForTeleportHashRequest)(nil),    // 38: ark.v1.SubscribeForTeleportHashRequest
	(*SubscribeForTeleportHashResponse)(nil),   // 39: ark.v1.SubscribeForTeleportHashResponse
	(*UnsubscribeForTeleportHashRequest)(nil),  // 40: ark.v1.UnsubscribeForTeleportHashRequest
	(*UnsubscribeForTeleportHashResponse)(nil), // 41: ark.v1.UnsubscribeForTeleportHashResponse
	(*TeleportEvent)(nil),                      // 42: ark.v1.TeleportEvent
	(*GetSubscriptionRequest)(nil),             // 43: ark.v1.GetSubscriptionRequest
	(*GetSubscriptionResponse)(nil),            // 44: ark.v1.GetSubscriptionResponse
	(*IndexerTxData)(nil),                      // 45: ark.v1.IndexerTxData
	(*IndexerHeartbeat)(nil),                   // 46: ark.v1.IndexerHeartbeat
	(*IndexerSubscriptionEvent)(nil),           // 47: ark.v1.IndexerSubscriptionEvent
	nil,                                        // 48: ark.v1.GetCommitmentTxResponse.BatchesEntry
	nil,                                        // 49: ark.v1.IndexerNode.ChildrenEntry
	nil,                                        // 50: ark.v1.IndexerSubscriptionEvent.CheckpointTxsEntry
}
var file_ark_v1_indexer_proto_depIdxs = []int32{
	48, // 0: ark.v1.GetCommitmentTxResponse.batches:type_name -> ark.v1.GetCommitmentTxResponse.BatchesEntry
	32, // 1: ark.v1.GetForfeitTxsRequest.page:type_name -> ark.v1.IndexerPageRequest
	33, // 2: ark.v1.GetForfeitTxsResponse.page:type_name -> ark.v1.IndexerPageResponse
	32, // 3: ark.v1.GetConnectorsRequest.page:type_name -> ark.v1.IndexerPageRequest
	26, // 4: ark.v1.GetConnectorsResponse.connectors:type_name -> ark.v1.IndexerNode
	33, // 5: ark.v1.GetConnectorsResponse.page:type_name -> ark.v1.IndexerPageResponse
	25, // 6: ark.v1.GetVtxoTreeRequest.batch_outpoint:type_name -> ark.v1.IndexerOutpoint
	32, // 7: ark.v1.GetVtxoTreeRequest.page:type_name -> ark.v1.IndexerPageRequest
	26, // 8: ark.v1.GetVtxoTreeResponse.vtxo_tree:type_name -> ark.v1.IndexerNode
	33, // 9: ark.v1.GetVtxoTreeResponse.page:type_name -> ark.v1.IndexerPageResponse
	25, // 10: ark.v1.GetVtxoTreeLeavesRequest.batch_outpoint:type_name -> ark.v1.IndexerOutpoint
	32, // 11: ark.v1.GetVtxoTreeLeavesRequest.page:type_name -> ark.v1.IndexerPageRequest
	25, // 12: ark.v1.GetVtxoTreeLeavesResponse.leaves:type_name -> ark.v1.IndexerOutpoint
	33, // 13: ark.v1.GetVtxoTreeLeavesResponse.page:type_name -> ark.v1.IndexerPageResponse
	32, // 14: ark.v1.GetVtxosRequest.page:type_name -> ark.v1.IndexerPageRequest
	27, // 15: ark.v1.GetVtxosResponse.vtxos:type_name -> ark.v1.IndexerVtxo
	33, // 16: ark.v1.GetVtxosResponse.page:type_name -> ark.v1.IndexerPageResponse
	25, // 17: ark.v1.GetVtxoChainRequest.outpoint:type_name -> ark.v1.IndexerOutpoint
	32, // 18: ark.v1.GetVtxoChainRequest.page:type_name -> ark.v1.IndexerPageRequest
	30, // 19: ark.v1.GetVtxoChainResponse.chain:type_name -> ark.v1.IndexerChain
	33, // 20: ark.v1.GetVtxoChainResponse.page:type_name -> ark.v1.IndexerPageResponse
	32, // 21: ark.v1.GetVirtualTxsRequest.page:type_name -> ark.v1.IndexerPageRequest
	33, // 22: ark.v1.GetVirtualTxsResponse.page:type_name -> ark.v1.IndexerPageResponse
	...
	49, // 26: ark.v1.IndexerNode.children:type_name -> ark.v1.IndexerNode.ChildrenEntry
	25, // 27: ark.v1.IndexerVtxo.outpoint:type_name -> ark.v1.IndexerOutpoint
	28, // 28: ark.v1.IndexerVtxo.extensions:type_name -> ark.v1.IndexerExtension
	29, // 29: ark.v1.IndexerExtension.asset:type_name -> ark.v1.IndexerAsset
	1,  // 30: ark.v1.IndexerChain.type:type_name -> ark.v1.IndexerChainedTxType
	0,  // 31: ark.v1.IndexerTxHistoryRecord.type:type_name -> ark.v1.IndexerTxType
	46, // 32: ark.v1.GetSubscriptionResponse.heartbeat:type_name -> ark.v1.IndexerHeartbeat
	47, // 33: ark.v1.GetSubscriptionResponse.event:type_name -> ark.v1.IndexerSubscriptionEvent
	27, // 34: ark.v1.IndexerSubscriptionEvent.new_vtxos:type_name -> ark.v1.IndexerVtxo
	27, // 35: ark.v1.IndexerSubscriptionEvent.spent_vtxos:type_name -> ark.v1.IndexerVtxo
	50, // 36: ark.v1.IndexerSubscriptionEvent.checkpoint_txs:type_name -> ark.v1.IndexerSubscriptionEvent.CheckpointTxsEntry
	27, // 37: ark.v1.IndexerSubscriptionEvent.swept_vtxos:type_name -> ark.v1.IndexerVtxo
	42, // 38: ark.v1.IndexerSubscriptionEvent.teleport_events:type_name -> ark.v1.TeleportEvent
	24, // 39: ark.v1.GetCommitmentTxResponse.BatchesEntry.value:type_name -> ark.v1.IndexerBatch
	45, // 40: ark.v1.IndexerSubscriptionEvent.CheckpointTxsEntry.value:type_name -> ark.v1.IndexerTxData
	2,  // 41: ark.v1.IndexerService.GetCommitmentTx:input_type -> ark.v1.GetCommitmentTxRequest
	4,  // 42: ark.v1.IndexerService.GetForfeitTxs:input_type -> ark.v1.GetForfeitTxsRequest
	6,  // 43: ark.v1.IndexerService.GetConnectors:input_type -> ark.v1.GetConnectorsRequest
	8,  // 44: ark.v1.IndexerService.GetVtxoTree:input_type -> ark.v1.GetVtxoTreeRequest
	10, // 45: ark.v1.IndexerService.GetVtxoTreeLeaves:input_type -> ark.v1.GetVtxoTreeLeavesRequest
	12, // 46: ark.v1.IndexerService.GetVtxos:input_type -> ark.v1.GetVtxosRequest
	14, // 47: ark.v1.IndexerService.GetVtxoChain:input_type -> ark.v1.GetVtxoChainRequest
	16, // 48: ark.v1.IndexerService.GetVirtualTxs:input_type -> ark.v1.GetVirtualTxsRequest
	18, // 49: ark.v1.IndexerService.GetAssetGroup:input_type -> ark.v1.GetAssetGroupRequest
	22, // 50: ark.v1.IndexerService.GetBatchSweepTransactions:input_type -> ark.v1.GetBatchSweepTransactionsRequest
	34, // 51: ark.v1.IndexerService.SubscribeForScripts:input_type -> ark.v1.SubscribeForScriptsRequest
	38, // 52: ark.v1.IndexerService.SubscribeForTeleportHash:input_type -> ark.v1.SubscribeForTeleportHashRequest
	40, // 53: ark.v1.IndexerService.UnsubscribeForTeleportHash:input_type -> ark.v1.UnsubscribeForTeleportHashRequest
	36, // 54: ark.v1.IndexerService.UnsubscribeForScripts:input_type -> ark.v1.UnsubscribeForScriptsRequest
	43, // 55: ark.v1.IndexerService.GetSubscription:input_type -> ark.v1.GetSubscriptionRequest
	3,  // 56: ark.v1.IndexerService.GetCommitmentTx:output_type -> ark.v1.GetCommitmentTxResponse
	5,  // 57: ark.v1.IndexerService.GetForfeitTxs:output_type -> ark.v1.GetForfeitTxsResponse
	7,  // 58: ark.v1.IndexerService.GetConnectors:output_type -> ark.v1.GetConnectorsResponse
	9,  // 59: ark.v1.IndexerService.GetVtxoTree:output_type -> ark.v1.GetVtxoTreeResponse
	11, // 60: ark.v1.IndexerService.GetVtxoTreeLeaves:output_type -> ark.v1.GetVtxoTreeLeavesResponse
	13, // 61: ark.v1.IndexerService.GetVtxos:output_type -> ark.v1.GetVtxosResponse
	15, // 62: ark.v1.IndexerService.GetVtxoChain:output_type -> ark.v1.GetVtxoChainResponse
	17, // 63: ark.v1.IndexerService.GetVirtualTxs:output_type -> ark.v1.GetVirtualTxsResponse
	19, // 64: ark.v1.IndexerService.GetAssetGroup:output_type -> ark.v1.GetAssetGroupResponse
	23, // 65: ark.v1.IndexerService.GetBatchSweepTransactions:output_type -> ark.v1.GetBatchSweepTransactionsResponse
	35, // 66: ark.v1.IndexerService.SubscribeForScripts:output_type -> ark.v1.SubscribeForScriptsResponse
	39, // 67: ark.v1.IndexerService.SubscribeForTeleportHash:output_type -> ark.v1.SubscribeForTeleportHashResponse
	41, // 68: ark.v1.IndexerService.UnsubscribeForTeleportHash:output_type -> ark.v1.UnsubscribeForTeleportHashResponse
	37, // 69: ark.v1.IndexerService.UnsubscribeForScripts:output_type -> ark.v1.UnsubscribeForScriptsResponse
	44, // 70: ark.v1.IndexerService.GetSubscription:output_type -> ark.v1.GetSubscriptionResponse
...
func file_ark_v1_indexer_proto_init() {
	...
	file_ark_v1_indexer_proto_msgTypes[26].OneofWrappers = []any{
		(*IndexerExtension_Asset)(nil),
	}
	file_ark_v1_indexer_proto_msgTypes[29].OneofWrappers = []any{
		(*IndexerTxHistoryRecord_CommitmentTxid)(nil),
		(*IndexerTxHistoryRecord_VirtualTxid)(nil),
	}
	file_ark_v1_indexer_proto_msgTypes[42].OneofWrappers = []any{
