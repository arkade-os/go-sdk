...
func (s *configStore) AddData(ctx context.Context, data types.Config) error {
	sd := &storeData{
		...
		SessionDuration:                fmt.Sprintf("%d", data.SessionDuration),
		...
		ExplorerTrackingPollInterval:   fmt.Sprintf("%.0f", data.ExplorerTrackingPollInterval.Seconds()),
		ExplorerTrackingBatchSize:      fmt.Sprintf("%d", data.ExplorerTrackingBatchSize),
		ExplorerTrackingBatchDelay:     fmt.Sprintf("%.0f", data.ExplorerTrackingBatchDelay.Seconds()),
		ExplorerTrackingMaxConnections: fmt.Sprintf("%d", data.ExplorerTrackingMaxConnections),
